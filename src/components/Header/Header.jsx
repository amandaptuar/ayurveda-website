          ...
          {user ? (
            <>
              <button 
                ...
                title="My Profile"
                style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '38px', height: '38px', borderRadius: '50%', backgroundColor: '#f0fdf4', color: 'var(--color-primary-green)', border: 'none', cursor: 'pointer', transition: 'background 0.2s' }}
              >
              ...
              <button 
                ...
                onClick={logout}
                title="Logout"
                style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '38px', height: '38px', borderRadius: '50%', backgroundColor: '#fef2f2', color: '#ef4444', border: 'none', cursor: 'pointer', transition: 'background 0.2s' }}
              >
